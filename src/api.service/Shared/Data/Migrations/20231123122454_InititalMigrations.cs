...
namespace api.service.Shared.Data.Migrations
{
    /// <inheritdoc />
    public partial class InititalMigrations : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("pk_access_token", x => x.internal_command_id);
                    table.ForeignKey(
                        name: "fk_access_token_asp_net_users_user_id",
                        column: x => x.user_id,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_access_token_token_user_id",
                table: "access_token",
